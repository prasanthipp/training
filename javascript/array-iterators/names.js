...
var count=0;
 var namestartz=names.forEach(function(item){
    if(item[0]==="z"){
      count=count+1;
    }
    return count;
...
var count=0;
 var namez=names.forEach(function(item){
    if(item.indexOf("z")>=0){
      count=count+1;
    }
    return count;
...
//3. Create a new array that contains all of the names containing a 'w' with the first letter upper-case.
   var letter="w";
   var namesofW=names.filter(function(item){
     return item[0]===letter.toUpperCase();
   })
   console.log(namesofW);
//4. Do all of the names contain vowels?
   var vowels=/[aeiou]/g;
   var cvowels=names.every(function(item){
     return vowels.test(item);
   });
   console.log(cvowels);
//5. Are there any names that have only two letters?
    var twoletters=names.some(function(item){
      return item.length===2;
    })
    console.log(twoletters);
//6. Is your name in the list?
     var myname=names.some(function(item){
       return item==="yosef";//true if prasanthi false
     })
     console.log(myname);
//7. Find the name that would come first alphabetically.
     var alpha=names.sort()[0];
     console.log(alpha);//aaden
//8. How many times does the letter 'z' appear in the list?
    var count=0;
    var z=names.forEach(function(item){
...
//var maxvowels=names.some(function(item){
...
var cars_VowelCount = names.forEach(function(car){
var maxVowelsInCar = 0;
if (countVowels(car) > 0 && countVowels(names) >= maxVowelsInCar){
maxVowelsInCar == countVowels(names);
}
return maxVowelsInCar;})
console.log(cars_VowelCount);
